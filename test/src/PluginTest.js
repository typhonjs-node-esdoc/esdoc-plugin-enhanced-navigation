...
describe('PluginTest', () =>
{
   it('Navigation Replacement', () =>
   {
      ...
      assert(indexHTML.includes('<input type="checkbox" name="folder-1" id="folder-1" checked><label for="folder-1" class="nav-dir-path" data-scm-link="https://github.com/typhonjs-backbone-parse/backbone-parse-es6/tree/master/src" data-scm-type="github">src</label>'));
   });
});